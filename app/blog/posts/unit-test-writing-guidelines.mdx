...
テストケース名だけで「何を・いつ・どうして」検証しているのか把握できるのが理想です。
...
ネストが深いほど読者の負荷が上がるので、グルーピングは 2 階層までに抑え、テストケース名に状況を織り込んでフラットにまとめるのがおすすめです。
...
テストの並びには本来意味を持たせたくないものの、私は「正常系→準異常系→異常系」の順に並べることが多いです。
