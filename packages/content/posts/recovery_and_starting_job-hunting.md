---
title: '復調と面接質問の回答'
summary: '2023 年 6 月末、私は体調を崩してしまいましたが、幸い 2 ヶ月の休養を経て、回復することができました。この回復を受けて、新たな職場での活動を再開することを決意し、正社員としての転職活動を始めることとしました。この記事では、これまでの 2 ヶ月間の出来事と、面接での質問への予想される回答をまとめています。'
tags: []
---
...
※体調を崩した背景や詳細については、[正社員を辞めました](https://silverbirder.github.io/blog/contents/left_my_full-time_job/)で詳しく触れていますので、ご興味があればご参照ください。
...
興味を持つ業界は特定していません。主に、ユーザーの困りごとや課題を解決することが働く動機となります。

これまでの経験では、toB 向けプロダクト開発が中心で、企業ユーザーからの問題解決を優先してきました。
プログラミングや技術は課題解決の一手段であり、初めに問題解決を行い、その後リファクタリングやアーキテクチャの見直しをすることが多いです。

また、職場の仲間、特にエンジニアの作業を助け、ストレスを減らす活動も積極的に行ってきました。
例として、CI の高速化、テストの自動化、ドキュメント整備などが挙げられます。

要するに、特定の業界よりも、「人のために困りごとを解決する」ことにモチベーションを感じており、その観点で選ぶ業界であれば、どこでも良いと考えています。
しかし、全く興味がない、関心がない業界は、選択肢から外しています。
...
フルスタックの経験を有し、新規プロダクト開発から大規模アプリの保守・運用、受託開発、及び自社サービス開発まで多様なプロジェクトを手がけてきました。
これらの経験から、効率的な運用を支える設計やシステム構築が得意です。
特に、開発者だけでなく、デザイナー、QA、PdM といったチーム全体のスムーズな作業をサポートする環境を意識的に作り上げてきました。

具体的には以下の通りです。

- API のパフォーマンス向上のため、バックエンドエンジニアと協力
- Storybook や Figma の運用方針をデザイナーと共同で確立
- QA と連携し、テスト自動化戦略を策定
- PdM と協同で、プロダクト仕様を明文化しドキュメント化
  - さらに、ATDD を利用し、PdM が期待する機能をテストで保証
- トイルを削減するための CI 強化

これまで多くのリアーキテクチャやリファクタリング活動を経験してきました。
これらの活動に多く携わった理由は、保守や運用の観点から将来を見越し、事前に必要な作業を実施しておくべきだと考えていたからです。
...
私は、 **ドライなコミュニケーションよりもウェットなコミュニケーション** を好みます。
ドライなコミュニケーションとは、情報の伝達に重点を置いたコミュニケーションです。
一方、ウェットなコミュニケーションとは、情報の伝達だけでなく、感情や思考を含めたコミュニケーションです。それはお礼や励まし、共感や理解などです。
私は、ウェットなコミュニケーションを通して、相手の気持ちや考えを理解し、共感することが重要だと考えています。
そのため、ウェットなコミュニケーションを好む人と一緒に働きたいと思っています。
...
過去の体調不良の経験を考慮し、 **働き方に「余裕」を持ちたい** と思っています。
常時 100%のパフォーマンスを追求するのではなく、仕事に対して時間的、精神的な「余裕」を持ち続けたいです。
これはサボりたいからではなく、中長期にわたり安定して働くためには、心と体の健康が不可欠と理解しているからです。
