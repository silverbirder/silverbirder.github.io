...
summary: '昔、HTML要素についてざっと学んだことがありましたが、記憶が曖昧になっています。改めてHTML要素を網羅的に理解し直したいと思い、HTML解体新書-仕様から紐解く本格入門という書籍を読んでみました。また、HTML 要素リファレンス - HTML: ハイパーテキストマークアップ言語 | MDNも参考にしました。この記事では、その中で特に印象に残った要素について紹介し、個人的な気づきについてお伝えします。'
tags: ["Review", "HTML"]
index: false
---
