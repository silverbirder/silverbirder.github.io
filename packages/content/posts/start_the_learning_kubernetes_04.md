...
[一足遅れて Kubernetes を学び始める - 03. Raspberry Pi -](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_03/)では、RaspberryPi の環境に Kubernetes を導入しました。無事、動作確認ができたので、さっそく学習していきたいです。
...
次回は[こちら](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_05/)です。
