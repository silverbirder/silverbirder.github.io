...
[一足遅れて Kubernetes を学び始める - 01. 環境選択編 -](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_01/)にて、Kubernetes を学ぶ環境を考えてみました。いきなり GKE を使うんじゃなくて、お手軽に試せる DockerForMac を使おうとなりました。
...
![Kubernetes_learning.png](https://res.cloudinary.com/silverbirder/image/upload/v1639816747/silver-birder.github.io/blog/Kubernetes_learning.png?ar=615%3A760)
...
次回は[こちら](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_03/)です。
