...
![REST_API](https://res.cloudinary.com/silverbirder/image/upload/v1659191676/silver-birder.github.io/blog/rest_api_flow.png?ar=2078%3A1700)

GraphQL の場合は、1 回の往復だけでデータが取得できます。

![GraphQL](https://res.cloudinary.com/silverbirder/image/upload/v1659191675/silver-birder.github.io/blog/graphql_flow.png?ar=1566%3A946)
