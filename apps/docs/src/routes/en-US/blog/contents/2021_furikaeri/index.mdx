...
The specific software I experienced was [Resume##Career](... /... /... /resume/index.mdxx) for your reference. Briefly, GCP/Terraform for cloud infrastructure, BigQuery and Digdag for data building.
...
For more information on this job search, see [Impressions after 10 casual interviews](...) /my_feedback_after_taking_casual_interviews_with_10_companies_in_2_months/index.mdxx).
