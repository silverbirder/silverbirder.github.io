...
export function LogosGoogleCloudPlatform(
  ...
  return (
    ...
    >
      ...
      ></path>
      <circle fill="#FFF" cx="127.766" cy="113.576" r="34.079"></circle>
      <path
...
export function MdiApi(props: QwikIntrinsicElements["svg"], key: string) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function MdiTranslate(props: QwikIntrinsicElements["svg"], key: string) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
