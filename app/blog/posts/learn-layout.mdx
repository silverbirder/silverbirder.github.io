...
<Image
  src="https://developer.mozilla.org/ja/docs/Learn_web_development/Core/CSS_layout/Flexbox/flex_terms.png"
...
<Image
  src="https://developer.mozilla.org/ja/docs/Web/CSS/CSS_flexible_box_layout/Controlling_ratios_of_flex_items_along_the_main_axis/basics7.png"
...
<Image
  src="https://developer.mozilla.org/ja/docs/Web/CSS/CSS_flexible_box_layout/Controlling_ratios_of_flex_items_along_the_main_axis/ratios1.png"
  alt="主軸方向のフレックスアイテムの比率の制御 - CSS: カスケーディングスタイルシート | MDN"
  href="https://developer.mozilla.org/ja/docs/Web/CSS/CSS_flexible_box_layout/Controlling_ratios_of_flex_items_along_the_main_axis"
  width={634}
  height={198}
...
グリッドを応用すれば、ヘッダー、サイドバー、メイン、フッターといった以下のようなレイアウトも簡単に構築できます。
...
.price-item {
  ...
  &.popular {
    border-color: var(--color-black); /* 人気プランは枠線を強調 */
  }
...
.popular-badge {
  ...
  left: 50%;
  /* 左に50%分ずらして、横中央に揃える */
  transform: translateX(-50%); /* 横方向の中央寄せテクニック */
...
.plan-price {
  ...
  & > span {
    margin-left: var(--spacing-xs); /* 単位との間隔 */
  }
}
...
.plan-feature {
  /* 装飾 */
  border-bottom: 1px solid var(--color-border); /* 特徴に下線をつける */
