...
:root {
  /* ---- 背景・面（Surface） ---- */
  --light-bg: var(--lightness-100);
  --light-surface: var(--lightness-60);
  --light-popover: var(--lightness-100);

  /* ---- Primary（ブランド色） ---- */
  --light-primary: var(--lightness-60);
  --light-primary-fg: var(--lightness-100);
}
```
