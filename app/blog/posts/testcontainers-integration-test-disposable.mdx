...
<Image
  src="https://res.cloudinary.com/silverbirder/image/upload/v1735639067/silver-birder.github.io/blog/testcontainers-overview.png"
  width={1322}
  height={1241}
  alt="概要図"
/>
...
<Image
  src="https://res.cloudinary.com/silverbirder/image/upload/v1735639029/silver-birder.github.io/blog/testcontainers-todo-app.png"
  width={686}
  height={547}
  alt="Todo App"
/>
...
2. APIおよびWebの各コンテナへのアクセスURLやオブジェクトを返す
3. テスト終了後にDockerコンテナを停止するTeardownを提供
