...
published: true
date: 2023-09-01
description: 2023 年 6 月末、私は体調を崩してしまいましたが、幸い 2 ヶ月の休養を経て、回復することができました。この回復を受けて、新たな職場での活動を再開することを決意し、正社員としての転職活動を始めることとしました。この記事では、体調の復調過程と、面接での質問への予想される回答をまとめています。
tags: ["Recovery", "Job Hunting"]
---

2023 年 6 月末、私は体調を崩してしまいましたが、幸い 2 ヶ月の休養を経て、回復することができました。この回復を受けて、新たな職場での活動を再開することを決意し、正社員としての転職活動を始めることとしました。この記事では、体調の復調過程と、面接での質問への予想される回答をまとめています。
...
これらの活動により、笑顔が増え、良い睡眠がとれるようになりました。
...
体調が安定してきた現在、正社員としての安定性が非常に魅力的に感じられます。
妻との会話の中で、将来を見据え、安定した収入と福利厚生を提供する正社員のポジションに移ることを決定しました。業務委託としての経験から、正社員の立場の価値を改めて理解しました。

この背景をもとに、正社員としてのキャリアを再追求する方向で、転職活動を開始することにしました。
現在お世話になっている企業には心から感謝しています。もちろん、この企業での正社員のポジションも考慮していますが、他の企業も含めて、正社員としてのポジションを探しています。
...
2016 年に Sler 企業に新卒として入社し、Web アプリケーションの開発・保守・運用を手掛けました。上流工程から下流工程までの幅広い業務を経験しました。その後 2018 年に大手 EC 企業へ移籍。こちらではフルスタックエンジニアとして、データ、インフラ、アプリケーションなど様々な面の経験を積むことができ、また大規模アプリケーションのリアーキテクチャやモダナイゼーションに貢献しました。2022 年には FinTech 企業 に転職し、フロントエンドエンジニアとして既存プロダクトの改修や新規プロダクトの開発に取り組みました。
...
私は、**学んだことや知識をオープン**にし、他者と共有することで、良質なプロダクトを生み出すことができると信じています。その中で、相乗効果を通じて自身も成長していきたいです。
...
情報を閉じ込めて仕事を進めると、進捗の共有や問題点の議論、助け合いの機会が減少します。結果のみが伝えられても、その過程が不明瞭であると、適切なサポートや評価が難しくなります。過程も、たとえ簡潔なログであれ、共有されることが望ましいと考えています。
...
体調不良の経験を踏まえ、余裕(余白)を持って働きたいと思います。
