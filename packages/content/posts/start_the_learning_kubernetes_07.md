...
[一足遅れて Kubernetes を学び始める - 06. workloads その 2 -](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_06/)にて、DaemonSet と StatefulSet(一部）を学習しました。今回は、StatefulSet の続きと Job,CronJob を学習します。
...
次回は[こちら](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_08/)です。
