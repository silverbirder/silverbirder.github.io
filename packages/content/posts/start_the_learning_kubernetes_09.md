...
[一足遅れて Kubernetes を学び始める - 08. discovery&LB その 1 -](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_08/)で Service についての概要を学びました。今回は下記を一気に学びます。
...
次回は[こちら](https://silverbirder.github.io/blog/contents/start_the_learning_kubernetes_10/)です。
